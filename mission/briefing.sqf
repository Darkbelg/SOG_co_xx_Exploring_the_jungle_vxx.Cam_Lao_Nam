...
if (side group player != CIVILIAN) then {
	...
	<br/>The nearby FSBs have been bomed by a local nearby VC camp.
	<br/>We need you to find it in the marked ao and neutralise it.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>We have vector 1 who can scout out the ao and be used as limited cas.
	<br/>It is optional but command could lead from vector 1.
	<br/>Insertion is done by convoy.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>We know of three vehicles being used by VC for supplies.
	<br/>At least one PAVN liaison officer will be in the camp.
	<br/>Expect patrols in the area. Getting engaged does not mean you are near an enemy camp.
	<br/>
